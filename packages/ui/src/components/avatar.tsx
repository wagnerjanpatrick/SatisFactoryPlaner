...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      className={cn(
        "group/avatar relative flex size-8 shrink-0 select-none overflow-hidden",
...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      className={cn(
        "flex size-full items-center justify-center bg-muted text-muted-foreground text-sm",
        "group-data-[size=sm]/avatar:text-xs",
        "group-data-[variant=circle]/avatar:rounded-full group-data-[variant=square]/avatar:rounded-none",
        className
      )}
